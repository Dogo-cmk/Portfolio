  ...
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <p className="max-w-xl text-gray-600 mb-8">
        I build meaningful web experiences and write poetry about life,things that I go through and think people also relate with and raw unfiltered emotions cleverly written in rhymes.
